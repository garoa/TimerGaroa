// Defini��es para o display JY-MCU 3208
...
#define CLK_CPU 2000000 // 2.0 MHz

// Conex�es do controlador HT1632C
// Tr�s sinais: CS, RD, WR e DT(DATA)
